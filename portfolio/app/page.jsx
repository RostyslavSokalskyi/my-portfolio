        ...
        <div className="flex flex-col xl:flex-row items-center justify-between xl:pt-8 xl:pb-24">
          <div className="text-center xl:text-left order-2 xl:order-none">
            ...
            <h1 className="h1 mb-6">
              Hello, I&apos;m <br />
              <span className="text-accent">Rostyslav </span>
            </h1>
            <p className="max-w-[500px] vb-9 text-white/80 mb-8">
              I am a programmer who strives to create innovative solutions that
